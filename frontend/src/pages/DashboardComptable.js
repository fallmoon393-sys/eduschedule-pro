            ...
            <div className="container mt-4">
                ...
                <div className="row g-3 mb-4">
                    <div className="col-md-4">
                        <div className="card text-white bg-dark">
                            <div className="card-body">
                                <h6 className="card-title">Total fiches</h6>
                    ...
                    <div className="col-md-4">
                        <div className="card text-white bg-success">
                            <div className="card-body">
                                <h6 className="card-title">Fiches approuvées</h6>
                    ...
                    <div className="col-md-4">
                        <div className="card text-white bg-primary">
                            <div className="card-body">
                                <h6 className="card-title">Total à payer</h6>
                                <h5>{totalMontant.toLocaleString()} FCFA</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="card">
                    <div className="card-header bg-white">
                        <h5 className="mb-0">Fiches de vacation</h5>
                    </div>
                    <div className="card-body">
                        {vacations.length === 0 ? (
